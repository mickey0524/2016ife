...
function Spacecraft(id, coordinatesX, coordinatesY, radius, speed, consumption, addition, planet) {
	this.id = id;
...
Spacecraft.prototype.init = function() {
	...
	setInterval(function() {
		...
		if(self.planet != null) {
			self.planet.binaryToStatus(self.statusToBinary());
		}
	}, 1000);
}
...
/**
 *飞船将自身状态转换为二进制
 *@Return {String} binaryStatus 飞船自身的二进制状态
 */
Spacecraft.prototype.statusToBinary = function() {
	var binaryStatus = this.id;
	switch(this.status) {
		case 0 : binaryStatus += '0010'; break;
		case 1 : binaryStatus += '0001'; break;
		case 2 : binaryStatus += '1100'; break;
		default: break;
	}
	binaryStatus += this.power;
	return binaryStatus;
}
